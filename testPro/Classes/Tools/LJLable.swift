...
class LJLable: UILabel {
  ...
  @objc private func tick(link: CADisplayLink) {
    ...
    attrMStr.setAttributes([.foregroundColor:fpsColor],range: NSMakeRange(0, attrMStr.length - 3))
    attrMStr.setAttributes([.foregroundColor:fpsColor],range: NSMakeRange( attrMStr.length - 3,3))
